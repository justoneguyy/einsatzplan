    ...
    <>
      <div className='fixed left-0 top-0 -z-50'>
        <div className='sticky left-0 top-0 h-screen w-screen overflow-hidden'>
          ...
          <div className='bg-gradient-radial absolute left-[--x] top-[--y] z-[-1] h-56 w-56 -translate-x-1/2 -translate-y-1/2 rounded-full from-muted-foreground/80 from-0% to-transparent to-90% blur-md' />
